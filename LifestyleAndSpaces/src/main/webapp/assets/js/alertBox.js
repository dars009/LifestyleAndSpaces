...
;(function($, window, document){
  ...
  var defaults = {
    ...
    title: '',  //标题文字
    continuebtn: '',   //左边按钮文字内容
    lBgColor: "#fc3752",  //左边按钮背景颜色
    lFontColor: "#fff",   //左边按钮文字颜色
    lCallback: function(){},    //左边按钮回调函数
    confirmbtn: '',   //右边按钮文字内容
    //rBgColor: "#ED6465",  //右边按钮背景颜色
    rBgColor: "#009587",  //右边按钮背景颜色
  ...
  AlertBox.prototype = {
    ...
    create: function(element){
      ...
      continuebtn = that.settings.continuebtn,
      confirmbtn = that.settings.confirmbtn,
      alertHTML = [];

      alertHTML[0] = '<div class="alert_panel"><h3 class="alert_title">' + title + '</h3>';
      alertHTML[1] = '<div class="alert_btn_group"><span class="alert_left_btn">'+ continuebtn + '</span>';
      alertHTML[2] = '<span class="alert_right_btn">' + confirmbtn + '</span></div>';
